 ...
 * @date 21 Sep 2022
 * @brief Simple linked list library made as part of assignment 1.
 *
 * Linked list implemented generic elements. Does not use dummy elements.
 * 
 * @see https://uppsala.instructure.com/courses/68435/assignments/149570
 */
...
/// @param value Succesful if index is valid, then value = the value inserted 
/// into the list. Otherwise Failure is returned. 
...
/// @param index the position in the list
/// @return Succesful if index is valid, then value = the value removed from the
/// list. Otherwise Failure is returned. 
...
/// @param list the linked list that will be extended
/// @param index the position in the list
/// @return Succesful if index is valid, then value = the value at index.
